...
contract raffleTest is Test {
    ...
    function testEmitsEventOnEntrance() public {
        vm.prank(PLAYER);
        // vm.expectEmit is a foundry cheatcode. check in foundry docs.
        vm.expectEmit(true, false, false, false, address(raffle)); // check topic 1, topic 2, topic 3, checkData(unindexed paramters)
    ...
    function testPerformUpkeepRevertsIfCheckUpkeepIsFales() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                Raffle.Raffle__upkeepIsNotNeeded.selector,
                currentBalance,
                numPlayers,
                rafflestate
            )
